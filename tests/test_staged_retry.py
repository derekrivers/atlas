...
# --- the live staged tickets version is v1.2.0 (ATLAS-110) -------------------


def test_orchestrator_uses_tickets_v1_2_0() -> None:
    assert STAGE_TICKETS_VERSION == "planner-stage-tickets-v1.2.0"
